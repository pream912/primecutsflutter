...
class AppStateNotifier extends ChangeNotifier {
  ...
  PrimecutsAuthUser? initialUser;
  PrimecutsAuthUser? user;
  ...
  void update(PrimecutsAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : LocationLoaderWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'AuthCopy',
          path: '/authCopy',
          builder: (context, params) => AuthCopyWidget(),
        ),
        FFRoute(
          name: 'ProductPage',
          path: '/productPage',
        ...
        FFRoute(
          name: 'NoShop',
          path: '/noShop',
          builder: (context, params) => NoShopWidget(),
        ),
        FFRoute(
          name: 'LocationLoader',
          path: '/locationLoader',
          builder: (context, params) => LocationLoaderWidget(),
        ),
        FFRoute(
          name: 'CategoriesPage',
          path: '/categoriesPage',
