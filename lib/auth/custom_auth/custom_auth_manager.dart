...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    primecutsAuthUserSubject.add(
      PrimecutsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PrimecutsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PrimecutsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PrimecutsAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    primecutsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
